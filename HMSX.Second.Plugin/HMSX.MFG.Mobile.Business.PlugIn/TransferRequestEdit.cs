            ...
            if (scanText != "")
            {
                ...
                if (rs.Count > 0)
                {
                    ...
                    for (int i = 0; i < rs.Count; i++)
                    {
                        ...
                        this.View.BillModel.SetValue("FStockStatusId", Convert.ToInt64(rs[i]["FSTOCKSTATUSID"]), rowCount - 1);
                        this.View.BillModel.SetValue("FStockStatusInId", Convert.ToInt64(rs[i]["FSTOCKSTATUSID"]), rowCount - 1);
